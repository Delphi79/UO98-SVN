...
namespace Irony.Parsing {
  ...
  public class ParsingContext {
    ...
    public void AddParserError(string message, params object[] args)
    {
        ...
        HasErrors = true;
        if (CurrentParserInput == null)
            AddParserMessage(ParserErrorLevel.Error, Source.Location, message, args);
        else
            AddParserMessage(ParserErrorLevel.Error, CurrentParserInput.Span, message, args);
    }
